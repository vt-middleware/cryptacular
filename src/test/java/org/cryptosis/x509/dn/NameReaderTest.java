...
public class NameReaderTest
{
  ...
  public Object[][] getSubjects()
  {
    return new Object[][] {
      ...
      new Object[] {
        ...
        "CN=glider.cc.vt.edu, SERIALNUMBER=1248110657961, OU=SETI, OU=Middleware-Client, O=Virginia Polytechnic Institute and State University, L=Blacksburg, ST=Virginia, DC=vt, DC=edu, C=US"
      },
    };
  }
  ...
  public Object[][] getIssuers()
  {
    return new Object[][] {
      new Object[] {
        CertUtil.readCertificate(CRT_PATH + "serac-dev-test.crt"),
        "DC=edu, DC=vt, C=US, O=Virginia Polytechnic Institute and State University, CN=DEV Virginia Tech Class 1 Server CA, SERIALNUMBER=12"
      },
      new Object[] {
        CertUtil.readCertificate(CRT_PATH + "glider.cc.vt.edu.crt"),

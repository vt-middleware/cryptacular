...
import org.cryptosis.util.CertUtil;
...
public class ExtensionReaderTest
{
  ...
  {
    return new Object[][] {
      new Object[] { CertUtil.readCertificate(CRT_PATH + "thawte-premium-server-ca.crt"), true },
      new Object[] { CertUtil.readCertificate(CRT_PATH + "login.live.com.crt"), false },
    };
  }
        ...
        new DistributionPoint[] {
          new DistributionPoint(
            new DistributionPointName(new GeneralNames(uri(
              "http://vtca-p.eprov.seti.vt.edu:8080/ejbca/publicweb/webdist/certdist?cmd=crl&" +
                "issuer=CN=Virginia+Tech+Middleware+CA,O=Virginia+Polytechnic+Institute+and+State+University," +
                "DC=vt,DC=edu,C=US"))),
            null,
  ...
  public void testReadSubjectAlternativeName(final X509Certificate cert, final String[] expected) throws Exception
  {
  ...
  public void testReadIssuerAlternativeName(final X509Certificate cert, final String[] expected) throws Exception
  {
  ...
  public void testReadBasicConstraints(final X509Certificate cert, final boolean expected) throws Exception
  {
  ...
  public void testReadSubjectKeyIdentifier(final X509Certificate cert, final String expected) throws Exception
  {
  ...
  public void testReadAuthorityKeyIdentifier(final X509Certificate cert, final String expected) throws Exception
  {
  ...
  public void testReadExtendedKeyUsage(final X509Certificate cert, final KeyPurposeId[] expected) throws Exception
  {

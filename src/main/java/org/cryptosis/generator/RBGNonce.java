...
/**
 * RBG-based nonce generation strategy that uses a RBG component to produce values for the invocation field as
 * described in NIST <a href="http://csrc.nist.gov/publications/nistpubs/800-38D/SP-800-38D.pdf">SP-800-38D</a>,
 * section 8.2.2.
 * <p>
 * <strong>NOTE:</strong> users of this class are responsible for counting number of invocations and enforcing
 * the constraints described in section 8.3; namely the following:
 * <blockquote>

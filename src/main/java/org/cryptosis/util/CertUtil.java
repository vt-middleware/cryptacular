/*
  $Id: X509Utils.java 2744 2013-06-25 20:20:29Z dfisher $
...
import org.cryptosis.x509.ExtensionReader;
import org.cryptosis.x509.GeneralNameType;
import org.cryptosis.x509.KeyUsageBits;
import org.cryptosis.x509.dn.AttributeType;
import org.cryptosis.x509.dn.NameReader;
...
public final class CertUtil
{
   ...
   *
   * @param  path  File containing an DER or PEM encoded X.509 certificate.
   *
   * @return  Certificate.
   */
   ...
   *
   * @param  input  Input stream containing PEM or DER encoded X.509 certificate.
   *
   * @return  Certificate.
   */

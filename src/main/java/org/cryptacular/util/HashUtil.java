...
public final class HashUtil
{
   ...
   *               and {@link Resource}. Character data is processed in the <code>UTF-8</code> character set;
  ...
  /**
   * Digests the data in the given stream. Note this method does not finalize the digest process by calling
   * {@link Digest#doFinal(byte[], int)}.
   *

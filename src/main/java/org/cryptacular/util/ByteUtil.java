...
public final class ByteUtil
{
  ...
  {
    return DEFAULT_CHARSET.encode(CharBuffer.wrap(CryptUtil.assertNotNullArg(s, "String cannot be null")));
  }
  ...
  {
    return CryptUtil.assertNotNullArg(s, "String cannot be null").getBytes(DEFAULT_CHARSET);
  }

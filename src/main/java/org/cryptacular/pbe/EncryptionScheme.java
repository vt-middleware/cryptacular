...
public interface EncryptionScheme
{
   ...
   * Use {@link org.cryptacular.io.EncodingOutputStream} to produce ciphertext bytes that encoded as a string data
   ...
   * Use {@link org.cryptacular.io.DecodingInputStream} to handle input ciphertext encoded as string data.
   *
